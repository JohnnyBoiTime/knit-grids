...
const PrivacyPolicy = () => {
  return (
    ...
    * **Project information** that you choose to save, including project names, stitch counts, needle information, yarn information, notes, progress information, and other information associated with your knitting projects.
    * **Technical information** that may be automatically processed by our hosting and infrastructure providers, such as IP addresses, request information, browser information, and server logs.
<br>
    </br>
    <br>
    </br>
...
<br>
    ...
    If you have questions about this Privacy Policy or your personal information, you can contact me at:

    chanky789@icloud.com
